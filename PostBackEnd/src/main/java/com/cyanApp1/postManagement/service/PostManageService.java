...
//	}
	...
	public Post addPosts(String userName, int postNumber, String location, String description,
			LocalDateTime targetDate) {
		Post post = new Post(userName, ++postCount,location,description,targetDate);
		posts.add(post);
		return post;
	}
